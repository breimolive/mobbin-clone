...
- Create Angular project with ng: `ng new angulardotnettemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angulardotnettemplate.client.esproj`).
